"""
Batch processing script for sleep stage inference

This script provides a simple way to process multiple patients and 
...
def main():
    ...
    for file in tqdm(os.listdir(file_paths.combined_data_folder)):
        if not file.endswith(".npz"):
            continue
            
        npz_file = os.path.join(file_paths.combined_data_folder, file)
